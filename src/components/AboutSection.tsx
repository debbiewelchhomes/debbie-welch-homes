        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          delay: 0.2
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-foreground leading-relaxed mb-4">Every real estate transaction is more than a business deal -  it's a major life event. I'm committed to being responsive, providing regular updates, and making sure you feel informed and confident at each step. My approach is grounded in integrity and calm, and I adapt my service to each client's situation, because no two real estate journeys are exactly alike.</p>
              <p className="text-foreground leading-relaxed mb-4">As a wife, mom, and gramma, I deeply understand the importance of home. Together with my husband, a retired Navy Veteran, we raised our blended family of six children in the Lake Stevens and Marysville communities. When I'm not serving clients, you'll usually find me volunteering with the Lake Stevens Education Foundation, traveling, exploring new local restaurants, breweries, and wineries, spending time with family, or day-tripping to the Pacific Northwest's beautiful coastal and mountain areas.</p>
