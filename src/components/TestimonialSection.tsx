...
const testimonials = [
  ...
  },
  {
    ...
    attribution: "M. Cornell, Marysville (senior out of state seller, full-service move help)",
  },
  {
    quote:
  ...
  },
  {
    ...
    attribution: "D. Hoskins, Oak Harbor (active military, investor, out of area seller)",
  },
  {
    quote:
