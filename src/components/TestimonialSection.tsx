          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-2xl">
            <CardContent className="p-8 md:p-12">
              <div className="text-center mb-8">
                <p className="font-script text-3xl md:text-5xl text-secondary mb-4" aria-hidden="true">Client stories…</p>
              ...
              align: "center",
              loop: true
            }} plugins={[autoplayPlugin.current]} className="w-full max-w-4xl mx-auto">
                <CarouselContent>
