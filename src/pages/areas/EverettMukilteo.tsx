...
const EverettMukilteo = () => {
  const areaName = "Everett & Mukilteo";
  
  return (
    <div className="min-h-screen">
      <SEO title={pageSEO.areas.everettMukilteo.title} description={pageSEO.areas.everettMukilteo.description} canonical="/areas/everett-mukilteo" />
      <Navigation />
      <main>
        {/* Hero Section */}
