  ...
  const expBenefits = [
    {
      ...
      description:
        "80/20 split until you cap, then 100% after that. No desk fees, no franchise fees, no royalties. The math is straightforward.",
    },
    {
      title: "Revenue Share",
      description:
    ...
    },
    {
      title: "Stock Awards",
      description:
        "Agents can earn eXp stock (EXPI) through transactions and milestones. It's a real ownership stake in the company you work with.",
    },
    {
    ...
    },
    {
      ...
      description:
        "eXp University offers live and on-demand training on everything from contracts to lead generation. Weekly sessions, recorded archives, accessible anywhere.",
    },
    {
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-foreground text-lg leading-relaxed">
                If any of it resonates, let's talk. If it doesn't, no hard feelings. I'd rather you make the right call
                for your business than join because of a good pitch.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="text-foreground text-lg leading-relaxed space-y-5">
                <p>
                  I didn't start at eXp. I started somewhere else, and when my situation there changed and I needed a
                ...
                <p>
                  That mattered to me. When I started asking questions about eXp, they answered honestly. When I
                  compared what eXp offered to what I had, the decision wasn't hard.
                </p>
                <p>I've been here five years, and I haven't regretted it.</p>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-foreground text-lg leading-relaxed mb-10">
                I'm not going to oversell this. Here's the straightforward version of what's on the table as an eXp
                agent.
              </p>
                    ...
                    <Card className="h-full border-border bg-card">
                      <CardContent className="p-6">
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <h3 className="font-heading text-xl font-bold text-primary">{benefit.title}</h3>
                        </div>
                        <p className="text-foreground leading-relaxed text-base pl-8">{benefit.description}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
        ...
        <section className="py-20 md:py-32 bg-background">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="text-foreground text-lg leading-relaxed space-y-5">
                <p>
                  Joining eXp is one decision. Choosing who you join under is a separate and equally important one. Your
                ...
                <p>
                  For me, the cloud brokerage model only works well if you're connected to real people. Entourage is
                  where that connection lives.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="py-20 md:py-32 bg-warm-bg">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="text-foreground text-lg leading-relaxed space-y-5">
                <p>
                  When I say I know agents in different markets and different states, I mean I've actually met them.
                  Talked with them. Worked alongside them in our group calls and meetings. These are not names in a
                  directory.
                </p>
                <p>
                ...
                <p>
                  That network is one of the things I value most about where I ended up. It changed how I think about
                  what it means to serve clients beyond my own backyard.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="mailto:debbie@debbiewelchhomes.com">Email Me Directly</a>
                </Button>
              </div>
            </motion.div>
          </div>
