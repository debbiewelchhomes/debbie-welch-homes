  ...
  return <section id="about" className="py-20 md:py-32 bg-warm-bg">
      <div className="container mx-auto px-4">
        ...
        duration: 0.6
          ...
          <p className="font-script text-3xl text-secondary mb-4 md:text-6xl">
            hey there…
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          delay: 0.2
            ...
            <img src={debbiePortrait} alt="Debbie Welch, Real Estate Broker" className="rounded-lg shadow-2xl w-full" />
          </motion.div>
        </div>
      </div>
    </section>;
